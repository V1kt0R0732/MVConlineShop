...
var showAlert = function (message, type) {
  ...
  var strong = alert.getElementsByTagName('strong')[0];
  ...
  setTimeout(hideAlert, 3000); // Алерт зникає через 3 секунди
};
    ...
    quantityWrapper.forEach(function (singleItem) {
      ...
      if (increaseButton) {
        increaseButton.addEventListener("click", function (e) {
          ...
          console.log("Increase button clicked. New value: " + input.value);
        });
      } else {
      ...
      if (decreaseButton) {
        decreaseButton.addEventListener("click", function (e) {
          ...
          console.log("Decrease button clicked. New value: " + input.value);
        });
      } else {
