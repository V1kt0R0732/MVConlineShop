    ...
    <div class="page-wrapper">
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Dell Category</h1>
                <ol class="breadcrumb">
            ...
            <div class="col-md-6">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Ви дійсно хочите видалити Сторінку: "<?=$page['name']?>"</div>
                    ...
                    <div class="ibox-body">
                        <form action="/admin/page/dell/resultForm" method="post">
                            <div class="row">
