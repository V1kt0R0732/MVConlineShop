    ...
    <nav class="page-sidebar" id="sidebar">
        <div id="sidebar-collapse">
            <div class="admin-block d-flex">
                <div>
<img src="/admin/images/user/<?=$_SESSION['user_avatar']?>" width="45px" />                </div>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            ...
                            <table class="table table-striped m-t-20 visitors-table">
                                ...
                                <tr>
                                    <td>
                                        <img class="m-r-10" src="/admin/template/assets/img/flags/us.png" />USA</td>
                                    <td>755</td>
                                    <td>
                                        <div class="progress">
                                ...
                                <tr>
                                    <td>
                                        <img class="m-r-10" src="/admin/template/assets/img/flags/Canada.png" />Canada</td>
                                    <td>700</td>
                                    <td>
                                        <div class="progress">
                                ...
                                <tr>
                                    <td>
                                        <img class="m-r-10" src="/admin/template/assets/img/flags/India.png" />India</td>
                                    <td>410</td>
                                    <td>
                                        <div class="progress">
                                ...
                                <tr>
                                    <td>
                                        <img class="m-r-10" src="/admin/template/assets/img/flags/Australia.png" />Australia</td>
                                    <td>304</td>
                                    <td>
                                        <div class="progress">
                                ...
                                <tr>
                                    <td>
                                        <img class="m-r-10" src="/admin/template/assets/img/flags/Singapore.png" />Singapore</td>
                                    <td>203</td>
                                    <td>
                                        <div class="progress">
                                ...
                                <tr>
                                    <td>
                                        <img class="m-r-10" src="/admin/template/assets/img/flags/uk.png" />UK</td>
                                    <td>202</td>
                                    <td>
                                        <div class="progress">
                                ...
                                <tr>
                                    <td>
                                        <img class="m-r-10" src="/admin/template/assets/img/flags/UAE.png" />UAE</td>
                                    <td>180</td>
                                    <td>
                                        <div class="progress">
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <ul class="media-list media-list-divider m-0">
                                <li class="media">
                                    <a class="media-img" href="javascript:;">
                                        <img src="/admin/template/assets/img/image.jpg" width="50px;" />
                                    </a>
                                    <div class="media-body">
...
<script src="/admin/template/assets/vendors/metisMenu/dist/metisMenu.min.js" type="text/javascript"></script>
<script src="/admin/template/assets/vendors/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<!-- PAGE LEVEL PLUGINS-->
<script src="/admin/template/assets/vendors/chart.js/dist/Chart.min.js" type="text/javascript"></script>
<script src="/admin/template/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js" type="text/javascript"></script>
<script src="/admin/template/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
<script src="/admin/template/assets/vendors/jvectormap/jquery-jvectormap-us-aea-en.js" type="text/javascript"></script>
<!-- CORE SCRIPTS-->
<script src="/admin/template/assets/js/app.min.js" type="text/javascript"></script>
<!-- PAGE LEVEL SCRIPTS-->
<script src="/admin/template/assets/js/scripts/dashboard_1_demo.js" type="text/javascript"></script>
</body>
