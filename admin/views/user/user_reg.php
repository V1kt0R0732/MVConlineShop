...
<div class="content">
    ...
    <?php } ?>
    <div class="brand">
        <a class="link" href="/admin/user">AdminCAST</a>
    </div>
    <form id="register-form" action="/admin/user/reg/res" method="post">
        ...
        <div class="form-group">
            <select class="form-control" name="status">
                <option value="0">Оберіть Права користувача</option>
        ...
        <div class="form-group">
            <input class="form-control" type="password" name="re_pass" placeholder="Confirm Password">
        </div>
        ...
        <div class="form-group">
            <button class="btn btn-info btn-block" type="submit" name="send">Sign up</button>
        </div>
        ...
        <div class="text-center">Already a member?
            <a class="color-blue" href="/admin/user/login">Login here</a>
        </div>
    </form>
</div>
