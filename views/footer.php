<footer class="footer__section footer__bg">
                ...
                <div class="col-lg-3 footer__col--width col-md-7 footer__col--padding footer__col--order">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget--inner">
                            <a class="footer__widget--logo" href="index.html"><imgsrc="/template/assets/img/logo/nav-log.png" alt="footer-logo"></a>
                            ...
                            <ul class="footer__widget--social d-flex">
                                ...
                                <li class="footer__widget--social__list">
                                    <a class="footer__widget--social__icon" target="_blank" href="https://twitter.com">
                                ...
                                <li class="footer__widget--social__list">
                                    <a class="footer__widget--social__icon" target="_blank" href="https://www.instagram.com">
                                ...
                                <li class="footer__widget--social__list">
                                    <a class="footer__widget--social__icon" target="_blank" href="https://www.youtube.com">
                ...
                <div class="col-12 col-md-auto">
                    <div class="footer__payment">
                        <ul class="footer__payment--inner d-flex">
                            <li class="footer__payment--list"><img src="/template/assets/img/other/payment1.png" alt="payment-img"></li>
                            <li class="footer__payment--list"><img src="/template/assets/img/other/payment2.png" alt="payment-img"></li>
                            <li class="footer__payment--list"><img src="/template/assets/img/other/payment3.png" alt="payment-img"></li>
                            <li class="footer__payment--list"><img src="/template/assets/img/other/payment4.png" alt="payment-img"></li>
                            <li class="footer__payment--list"><img src="/template/assets/img/other/payment5.png" alt="payment-img"></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <img class="footer__position--shape__one" src="/template/assets/img/other/footer-shape1.png" alt="footer-shape">
    <img class="footer__position--shape__two" src="/template/assets/img/other/footer-shape2.png" alt="footer-shape">
</footer>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product1.jpg"><img class="product__media--preview__items--img"src="/template/assets/img/product/big-product1.jpg" alt="product-media-img"></a>
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product2.jpg"><img class="product__media--preview__items--img"src="/template/assets/img/product/big-product2.jpg" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product3.jpg"><img class="product__media--preview__items--img"src="/template/assets/img/product/big-product3.jpg" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product4.jpg"><img class="product__media--preview__items--img"src="/template/assets/img/product/big-product4.jpg" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product5.jpg"><img class="product__media--preview__items--img"src="/template/assets/img/product/big-product5.jpg" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product6.jpg"><img class="product__media--preview__items--img"src="/template/assets/img/product/big-product6.jpg" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"src="/template/assets/img/product/small-product6.png" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"src="/template/assets/img/product/small-product1.png" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"src="/template/assets/img/product/small-product2.png" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"src="/template/assets/img/product/small-product4.png" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"src="/template/assets/img/product/small-product5.png" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img"src="/template/assets/img/product/small-product3.png" alt="product-nav-img">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <fieldset class="variant__input--fieldset">
                                        ...
                                        <div class="variant__color d-flex">
                                            <div class="variant__color--list">
                                                ...
                                                <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img"src="/template/assets/img/product/product1.png" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red2" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img"src="/template/assets/img/product/product2.png" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red3" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img"src="/template/assets/img/product/product3.png" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red4" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img"src="/template/assets/img/product/product4.png" alt="variant-color-img"></label>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
