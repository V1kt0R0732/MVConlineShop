                    ...
                    <div class="product__details--media">
                        <div class="product__media--preview  swiper">
                            <div class="swiper-wrapper">
                                <?php if(!empty($photo_id)){ for($i = 0; $i < count($photo); $i++){ if($photo[$i]['id'] == $photo_id){ ?>
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href=""><img class="product__media--preview__items--img" src="/admin/images/product/<?=$photo[$i]['photo']?>" style="width:400px;" alt="product-media-img"></a>
                                ...
                                <?php } } } else{ for($i = 0; $i < count($photo); $i++) { if($photo[$i]['status'] == 1){ ?>
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href=""><img class="product__media--preview__items--img" src="/admin/images/product/<?=$photo[$i]['photo']?>" style="width:400px;" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product2.jpg"><img class="product__media--preview__items--img" src="/admin/images/product/<?=$photo[1]['photo']?>" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                            ...
                            <?php if(!empty($photo_id)){ for($i = 0; $i < count($photo); $i++){ if($photo[$i]['id'] != $photo_id){ ?>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <a href="/catalog/detail/<?=$product['id']?>/<?=$photo[$i]['id']?>"><img class="product__media--nav__items--img" src="/admin/images/product/<?=$photo[$i]['photo']?>" style="max-height:100px; width=50px" alt="product-nav-img"></a>
                                    </div>
                                </div>
                            <?php } } } else{ for($i = 0; $i < count($photo); $i++){ if($photo[$i]['status'] != 1){  ?>
                                <div class="swiper-slide">
...
<!--                                        Add to Wishlist-->
<!--                                    </a>-->
                                    <a href="/basket/add/<?=$product['id']?>"><button class="variant__buy--now__btn btn">Add to a Cart</button></a>
                                </div>
                                <div class="product__variant--list mb-15">
                            ...
                            <div class="guarantee__safe--checkout">
                                ...
                                <img class="guarantee__safe--checkout__img" src="/template/assets/img/other/safe-checkout.png" alt="Payment Image">
                            </div>
                        </form>
                    </div>
                </div>
                                    ...
                                    <div class="reviews__comment--area">
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img src="/template/assets/img/other/comment-thumb1.png" alt="comment-thumb">
                                            </div>
                                        ...
                                        <div class="reviews__comment--list margin__left d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img src="/template/assets/img/other/comment-thumb2.png" alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">
                                                    <div class="reviews__comment--top__left">
                                        ...
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img src="/template/assets/img/other/comment-thumb3.png" alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">
                                                    <div class="reviews__comment--top__left">
