...
<!--<button onclick="showAlert('Успех! Вы успешно вошли в систему.', 'success');">Показать алерт</button>-->
        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="/catalog/index/0/1"><img class="main__logo--img" src="/template/assets/img/logo/nav-log.png" alt="logo-img"></a></h1>
                </div>
                    ...
                    <div class="dropdown__categories--menu">
                        <ul class="d-none d-lg-block">
                            <li class="categories__menu--items">
                                <a class="categories__menu--link" href="/catalog/index/0">
...
<!--                                </a>-->
<!--                                <ul class="categories__submenu border-radius-10 d-flex justify-content-between">-->
<!--                                    <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html"><strong>Hot Offers</strong></a>-->
<!--                                        <ul class="categories__submenu--child">-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html"> AFresh Seafood</a></li>-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Oil and Vinegar </a></li>-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Bread and Juice </a></li>-->
...
<!--                                        </ul>-->
<!--                                    </li>-->
<!--                                    <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html"><strong>Fresh Meat</strong></a>-->
<!--                                        <ul class="categories__submenu--child">-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Apple Juice </a></li>-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Oil and Vinegar </a></li>-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Bread and Juice </a></li>-->
...
<!--                                        </ul>-->
<!--                                    </li>-->
<!--                                    <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="shop.html"><strong>Nature Food</strong></a>-->
<!--                                        <ul class="categories__submenu--child">-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Apple Juice </a></li>-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Oil and Vinegar </a></li>-->
<!--                                            <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="shop.html">Bread and Juice </a></li>-->
...
<!--                            </li>-->
                    ...
                    <div class="header__right--info d-flex align-items-center">
                        <div class="account__currency">
                            <a class="account__currency--link text-white" href="javascript:void(0)">
                                <img src="/template/assets/img/icon/usd-icon.png" alt="currency">
                                <span>USD</span>
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="/template/assets/img/logo/nav-log.png" alt="Grocee Logo" width="158" height="36">
                </a>
    ...
    <div class="offCanvas__minicart">
        <div class="minicart__header ">
            ...
            <p class="minicart__header--desc"><?php if(isset($_SESSION['basket']) && !empty($_SESSION['basket'])) echo "Ваші Товари:"; else  echo "Корзина наразі пуста";?></p>
        </div>
        <div class="minicart__product">
            <?php $totalPrice = 0; if(isset($_SESSION['basket']) && !empty($_SESSION['basket'])){ for($i = 0; $i < count($_SESSION['basket']); $i++){ ?>
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="/admin/images/product/<?=$_SESSION['basket'][$i]['photo']?>" alt="prduct-img"></a>
                </div>
            ...
            <?php $totalPrice += $_SESSION['basket'][$i]['price']*$_SESSION['basket'][$i]['count']; } }?>
        </div>
        ...
        <div class="minicart__button d-flex justify-content-center">
            <a class="btn minicart__button--link" href="/catalog/basket">View cart</a>
            <a class="btn minicart__button--link" href="/catalog/order">Checkout</a>
        </div>
        <?php } ?>
    </div>
